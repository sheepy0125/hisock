...
class HiSockServer:
    ...
    def _get_all_client_sockets_in_group(self, group: str) -> list[socket.socket]:
        """
    ...
    def send_client_raw(self, client, content: bytes):
        ...
        self._get_client_from_name_or_ip_port(client).send(content_header + content)
